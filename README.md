...
- **Backend:** High-performance serverless runtime deployed on **Cloudflare Workers**.
- **Database:** Fully distributed SQL layer powered by **Cloudflare D1** for lightning-fast user configuration and encrypted note synchronization.
- **AI Integration:** Direct, low-latency API integration with **Google Gemini** for instant text/creative content generation.

## ✨ Core Features
- **Context-Aware AI Assistant:** Generates professional emails, scripts, rap verses, and captions directly within the note editor layer.
